  ...
  handler: async (ctx): Promise<Record<string, unknown>> => {
    ...
    return {
      ...
      week: {
        ...
        blended_cac: weekShopify.orders > 0 ? Math.round(metaWeek.spend / weekShopify.orders) : 0,
      ...
      prev_week: {
        ...
        blended_cac: prevWeekShopify.orders > 0 ? Math.round(metaPrevWeek.spend / prevWeekShopify.orders) : 0,
